...
angular.module('o2oWechatIou')
  .controller('MainCtrl', ['$scope', '$state', '$rootScope', '$stateParams', 'restmod', 'DEFAULT_DOMAIN', 'config', 'IouUser', function($scope, $state, $rootScope, $stateParams, restmod, DEFAULT_DOMAIN, config, IouUser) {
